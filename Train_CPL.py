...
# Define the custom reparametrization that enforces the initial condition:
condition = [CustomCondition(reparam_CPL)]

# Define the custom neural netowrk architecture:
...
solver = BundleSolver1D(ode_system=ODE_CPL,
